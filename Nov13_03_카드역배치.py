...
'''
a=list(range(1,21))         #우선 리스트에 1~20을 저장. 0부터 저장하고 나중에 pop(0)으로 해도 됨.
for k in range(10):         # 변수 안 주고 _(언더바)를 줘도 됨. 큰 의미는 없고 메모리 줄이기용
    s, e = map(int,input().split())
    for i in range((e-s+1)//2):     #구간이 주어졌을 떄 몇 번 스왑 하는지
        a[(s-1)+i],a[(e-1)-i] = a[(e-1)-i],a[(s-1)+i]   #숫자 스왑해주는 기능. 인덱스 번호 주의
print(a)
